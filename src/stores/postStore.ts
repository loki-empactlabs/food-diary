...
const MOCK_POSTS: FoodPost[] = [
  {
    ...
    rating: 5,
    comment: '도우 얇고 바삭. 치즈 쭉쭉 늘어남. 토핑도 신선했고 양 넉넉. 여기 또 오자',
    menu_name: '마르게리타 피자',
    price: 18000,
    tags: ['피자', '이탈리안', '강남맛집'],
  ...
  },
  {
    ...
    rating: 4,
    comment: '국물 진하고 면 쫄깃. 차슈 부드러웠음. 다음엔 곱빼기로',
    menu_name: '돈코츠 라멘',
    price: 12000,
    tags: ['라멘', '일식', '홍대'],
  ...
  },
  {
    ...
    rating: 5,
    comment: '크림 안 무겁고 딸기 진짜 달다. 사진보다 실물이 나음. 재방문 확정',
  ...
  },
  {
    ...
    rating: 3,
    comment: '양은 많은데 맛은 그냥 그럼. 급할 때 가는 정도. 굳이 또 갈 필요는 없겠다',
    menu_name: '제육볶음 정식',
    price: 9000,
    tags: ['한식', '정식', '회사밥'],
